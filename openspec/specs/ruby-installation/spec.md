...
Defines how Ruby is installed in the Docker image using prebuilt binaries from `jdx/ruby`, replacing source compilation. Covers binary download, checksum verification, rdoc/ri cleanup, patch infrastructure removal, and unchanged gem/bundler workflow.
